export const USERS = {
  1: {
    id: 1,
    email: 'nice.academy.student@inmind.ai',
    password: 'topsecret'
  }
...
export const COURSES: any = {
  ...
  4: {
    id: 4,
    description: 'Angular deep dive - FE track',
    longDescription: 'Diving into frontend developent and UI design.',
  ...
  2: {
    ...
    longDescription: 'A detailed walk-through of backend intricacies with dotnet and the DDD architecture',
  ...
  3: {
    id: 3,
    description: 'Observability in frontend',
    longDescription: 'The observable pattern in angular with Rxjs',
  ...
  1: {
    id: 1,
    description: 'Angular 17 features!',
    longDescription: 'Signals, standalone components, zoneless angular?',
  ...
  12: {
    ...
    longDescription: 'How to unit test',
  ...
  7: {
    id: 7,
    description: 'Angular PWA and web workers',
  ...
  9: {
    id: 9,
    description: 'API history',
    longDescription: 'Guide on API histories and types of web servers',
  ...
  13: {
    id: 13,
    description: 'The onion architecture',
    longDescription: 'More than cooking: Data flow in multi-tier architecture, implementation in dotnet',
    iconUrl: 'https://angular-academy.s3.amazonaws.com/thumbnails/typescript-2-small.png',
    category: 'BACKEND',
    seqNo: 10,
    url: 'typescript-course'
